...
extern int oemmsg_diag_state(void);
extern void oemmsg_diag_state_change(void* buf);
extern void oemmsg_set_diag_enable(void);
...
{
    uint32_t arg1 = PROC_COMM_SUB_CMD_DIAG_ENABLE;
    uint32_t arg2 = 0;
    int l_proc_ret = 0;
    ...
    l_proc_ret = msm_proc_comm(PCOM_CUSTOMER_CMD2, &arg1, &arg2);
    if(!l_proc_ret && arg2 != 0)
    {
        oemmsg_set_diag_enable();
    }
	return;
err:
